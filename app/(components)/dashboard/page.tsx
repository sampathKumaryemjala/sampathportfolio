...
export default function DashboardPage() {
    ...
    return (
        <Layout>
            <div className="min-h-screen bg-gradient-to-br from-purple-50 to-blue-50 py-8 sm:py-12">
                    ...
                    <div className="max-w-6xl mx-auto">
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 mb-8 sm:mb-12">
                            ...
                            <Card>
                                <div className="p-4 sm:p-6 text-center">
                                    ...
                                    <div className="text-sm sm:text-base text-gray-600">Blog Posts</div>
                                </div>
                            </Card>
                            <Card>
                                <div className="p-4 sm:p-6 text-center">
                                    <div className="text-2xl sm:text-3xl font-bold text-green-600 mb-2">24</div>
                                    <div className="text-sm sm:text-base text-gray-600">Messages</div>
                                </div>
                            </Card>
                            <Card>
                                <div className="p-4 sm:p-6 text-center">
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 sm:gap-8">
                                    ...
                                    <div className="space-y-4">
                                        ...
                                        <div className="flex items-center gap-3">
                                            ...
                                            <div>
                                                ...
                                                <div className="font-semibold text-gray-900">{session?.user?.email || 'user@example.com'}</div>
                                            </div>
                                        </div>
                            ...
                            <Card className="lg:col-span-2">
                                <div className="p-6 sm:p-8">
                                    <h2 className="text-xl sm:text-2xl font-bold text-gray-900 mb-6">Recent Activity</h2>
                                    
                                    <div className="space-y-4">
                                        <div className="flex items-start gap-3 p-3 bg-gray-50 rounded-lg">
                                            <div className="w-2 h-2 bg-green-500 rounded-full mt-2"></div>
                                            <div>
                                                <div className="text-sm font-semibold text-gray-900">New project created</div>
