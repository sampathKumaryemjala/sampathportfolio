                ...
                <div className="container mx-auto px-4 sm:px-6">
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8 max-w-7xl mx-auto">
                        {plans.map((plan, index) => (
                            <Card key={index} className={`relative ${plan.popular ? 'ring-2 ring-purple-500 dark:ring-purple-400 scale-105' : ''}`}>
                                {plan.popular && (
                                ...
                                <div className="p-6 sm:p-8">
                                    <div className="text-center mb-6">
                                        ...
                                        <p className="text-gray-600 dark:text-gray-300 text-sm sm:text-base mb-4">{plan.description}</p>
            ...
            <section className="py-16 sm:py-20 bg-white dark:bg-gray-800">
                <div className="container mx-auto px-4 sm:px-6">
                    <div className="max-w-4xl mx-auto text-center">
                        <h2 className="text-3xl sm:text-4xl font-bold text-gray-900 dark:text-white mb-6">Frequently Asked Questions</h2>
